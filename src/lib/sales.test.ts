...
async function fixture() {
  ...
  const product = await prisma.product.create({ data: { businessId: first.id, name: "Lámpara", category: "Hogar", condition: "Buen estado", description: "Lámpara de mesa usada", photoPath: "/test.jpg", costCents: 10000, priceCents: 18000 } });
